...
import com.github.kchard.service.Predicate
import com.github.kchard.service.PredicateShutdownMonitor
import com.github.kchard.util.itestUtils.MultiThreadedUtil

class PredicateMonitorTest {
	...
	PredicateShutdownMonitor monitor
	...
	void setUp() {
		...
		def predicate = [evaluate: {true}] as Predicate
		
		monitor = new PredicateShutdownMonitor(service, MONITOR_INTERVAL, predicate)
	}
	...
	void testUnhandledException() {
		...
		def predicate = [evaluate: {false}] as Predicate
